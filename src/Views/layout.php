...
function isActive($path, $current = null) {
    if ($current === null) {
        $current = parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH);
    }
    return strpos($current, $path) === 0 ? 'border-l-4 border-gray-800 bg-gray-100' : '';
}
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title><?php echo $title ?? 'Candidacy Management System'; ?></title>
