...
<?php include __DIR__ . '/../layout/header.php'; ?>
    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-lg shadow p-8">
            <h2 class="text-2xl font-bold text-gray-900 mb-6">Add New Party</h2>

            <form method="POST" action="/parties" class="space-y-6">
                <!-- Party Name -->
                <div>
                    <label for="name" class="block text-sm font-medium text-gray-900 mb-2">Party Name</label>
                    <input type="text" name="name" id="name" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-800 focus:border-transparent" placeholder="e.g., Democratic Party">
                </div>
